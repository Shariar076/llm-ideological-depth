...
if __name__ == "__main__":
    ...
    if args.mode == "personality_steering" or args.mode == "personality_steering_131K":
        ...
        if args.select_type == "sae_vector":
            ...
            # ques = "<start_of_turn>user\nQurstion: " + vector_dataset[i]["question"] + "\n<start_of_turn>model"
                ...
                # # # 生成vector的input_forma体现在--args.AB: The input_forma that generates the vector is reflected in --args.AB
    ...
    if args.select_type == "only_sys":
        ...
        # )
        # print(">>> Storing selection_record at: ", args.output_file)
        # json.dump(
        #     selection_record,
